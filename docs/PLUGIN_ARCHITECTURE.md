...
- headless 测试矩阵 v3 蒙版保护 13 项（孤儿告警不收底/母版不被污染/源孤儿蒙版不被缩小/有母版蒙版随系数重印同步/.no 全链路不碰/双写核心两份两尺寸…）+ 删除核心 11 项（母版双份删净/sidecar 清走/不误伤底图与其它档/幂等重删/非母版单删/删后缩放不复活）全通过（2026-09-13）
